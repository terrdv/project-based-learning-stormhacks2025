    ...
    <div className="min-h-screen bg-background">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 sm:py-32">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <h1 className="text-5xl font-bold mb-6">
              Your AI mentor for project-based learning.
            </h1>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
        <div className="text-center mb-16">
          <h2 className="text-2xl font-bold mb-4">Everything You Need to Succeed</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {features.map((feature, index) => (
            <Card key={index} className="border-border hover:border-primary/50 transition-colors text-left">
              <CardHeader>
      ...
      <section className="bg-muted/30 border-y border-border py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-2xl font-bold mb-4">Popular Learning Projects</h2>
            <p className="text-muted-foreground max-w-2xl mx-auto">
